...
try:
    ...
    print("Error: Monster's Combat Strength must be an integer.")
    exit()

# Roll the dice for player's health points
input("Roll the dice for your health points (Press enter)")
healthPoints = random.choice(diceOptions)
print("You rolled " + str(healthPoints) + " health points")

# Roll the dice for monster's health points
...
# Define the weapons array and roll for a weapon
weapons = ["Fist", "Knife", "Club", "Gun", "Bomb", "Nuclear bomb"]
input("Roll the dice to choose your weapon (Press enter)")
weaponRoll = random.choice(diceOptions)
heroWeapon = weapons[weaponRoll - 1]  # Subtract 1 for zero-based index

# Add weaponRoll to hero's combat strength
combatStrength += weaponRoll
print(f"You rolled a {weaponRoll} and your weapon is a {heroWeapon}")
